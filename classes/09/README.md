...
script: |
  (function () {
    if (window.__goatcounter_loaded__) return;
    window.__goatcounter_loaded__ = true;
...
https://liascript.github.io/course/?https://raw.githubusercontent.com/AndreaInfUFSM/elc117-2026a/master/classes/09/README.md
-->

[![LiaScript](https://raw.githubusercontent.com/LiaScript/LiaScript/master/badges/course.svg)](https://liascript.github.io/course/?https://raw.githubusercontent.com/AndreaInfUFSM/elc117-2026a/main/classes/09/README.md)
...
- Visão computacional com modelos de detecção de objetos
- Detecção/inferência = função
- Entrada: imagem
- Saída: para cada objeto, bounding box (x1,y1,x2,y2), score (0-1) e classe/categoria

> Participe de um teste aqui: https://andreainfufsm.github.io/client-side-ai-demos/demos/efficientdet-lite0-benchmark
</div>

<div>

![Fonte: http://d2l.ai/chapter_computer-vision/anchor.html](img/output_anchor_f592d1_192_0.svg)
...
**Classes**: Cada objeto detectado é classificado em uma de várias classes (ou caregorias) pré-definidas. Por exemplo, um modelo treinado para detectar animais pode incluir as classes "dog" e "cat".
                          ...
                          --{{0}}--
A imagem ao lado ilustra bounding boxes (retângulos em torno dos "objetos"), classes ("dog" e "cat") e scores (0.9 para ambos os objetos).


### Dados para teste

- Listas **inter-relacionadas** de bounding boxes, scores e classes de objetos

- Exemplo: 3 objetos detectados, sendo o primeiro: classe 0, score 0.95, bounding box (34.0, 60.0, 200.0, 320.0)
...
Essas listas são inter-relacionadas e possuem o mesmo número de elementos, cada elemento correspondente a um objeto detectado. O primeiro elemento em cada uma das listas refere-se ao primeiro objeto, e assim por diante. 
                          ...
                          --{{0}}--
Por exemplo, neste código, o primeiro objeto é da classe 0, com score 0.95 e com bounding box (34.0, 60.0, 200.0, 320.0).
