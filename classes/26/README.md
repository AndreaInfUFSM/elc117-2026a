...
[![LiaScript](https://raw.githubusercontent.com/LiaScript/LiaScript/master/badges/course.svg)](https://liascript.github.io/course/?https://raw.githubusercontent.com/AndreaInfUFSM/elc117-2026a/main/classes/26/README.md)
...
<script>
  window.goatcounter.count({
    path: "/elc117-2026a/classes/26",
    title: "/elc117-2026a/classes/26"
  })
</script>
...
Execução **sequencial** de tarefas: `main` executa A -> B -> C -> D (apenas uma ordem possível)
...
No entanto, em muitos casos existem tarefas **independentes**

- mais de uma sequência é possível
- mas com programação sequencial não conseguimos expressar isso
...
2. Especificar dados próprios e/ou compartilhados
   ...
   - passar referências para objetos e/ou acessar atributos de classe (`static`)
